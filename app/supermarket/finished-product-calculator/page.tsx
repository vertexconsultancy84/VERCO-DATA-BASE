...
import FinishedProductCalculator from "@/components/FinishedProductCalculator";
import SupermarketNavbar from "@/components/SupermarketNavbar";
import Header from "@/components/Header";
import Link from "next/link";
import { Calculator, ArrowLeft } from "lucide-react";

export default function SupermarketFinishedProductCalculatorPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-28 pb-16 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold">Finished Products Price Calculator</h1>
              <p className="mt-1 text-white/80">Calculate total cost, recommended selling price and net profit for any product</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <FinishedProductCalculator variant="supermarket" />
      </div>
    </div>
  );
}
