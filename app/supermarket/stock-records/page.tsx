...
export default function SupermarketStockRecordsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-28 pb-16 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-white/80">Record and track all raw materials and finished product costs</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <StockRecords variant="supermarket" />
      </div>
    </div>
  );
}
