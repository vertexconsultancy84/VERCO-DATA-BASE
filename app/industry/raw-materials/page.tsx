...
import { MapPin, Star, Home, Layers, Factory } from "lucide-react";
  ...
  const fetchProducts = async () => {
    try {
      ...
      const filtered = allProducts.filter(
        (p) => p.category === "Industry" && p.subcategory === "raw-materials"
      );
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#023E4A] to-[#0097A7] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-32 pb-20 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-slate-200 max-w-3xl mx-auto">
            Industrial raw materials and inputs for manufacturing
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Raw Materials</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Raw Materials Yet</h3>
            <p className="text-gray-600">Be the first to list raw materials on our marketplace!</p>
            <Link href="/user/dashboard">
              <Button className="mt-4 bg-[#023E4A] hover:bg-[#012830]">Add Raw Materials</Button>
            </Link>
          </div>
        ) : (
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <Link
            ...
            className="inline-flex items-center px-6 py-3 border border-teal-300 text-teal-700 rounded-lg hover:bg-teal-50 transition-colors"
          >
