...
import { MapPin, Calendar, Phone, Mail, MessageSquare, Utensils, Star, Filter, Home } from "lucide-react";
...
export default function RestaurantPage() {
  ...
  const fetchRestaurantProducts = async () => {
    try {
      ...
      const restaurantProducts = allProducts.filter(
        product => product.category === 'Food' && product.subcategory === 'restaurant'
      );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-red-600 to-red-500 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-32 pb-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-red-100 max-w-3xl mx-auto">
              Discover amazing dining experiences and culinary delights
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <Utensils className="h-12 w-12 text-[#023E4A] mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <MapPin className="h-12 w-12 text-[#023E4A] mx-auto mb-4" />
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Be the first to add a restaurant to our marketplace!
            </p>
            <Link href="/user/dashboard">
              <Button className="mt-4 bg-[#D4A017] hover:bg-[#b8880f] text-[#023E4A] font-semibold">
                Add Your Restaurant
              </Button>
            </Link>
          </div>
