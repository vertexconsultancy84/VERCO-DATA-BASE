...
import { MapPin, Calendar, Phone, Mail, MessageSquare, ShoppingBasket, Star, Filter, Home } from "lucide-react";
...
export default function GroceryPage() {
  ...
  const fetchGroceryProducts = async () => {
    try {
      ...
      const groceryProducts = allProducts.filter(
        product => product.category === 'Food' && product.subcategory === 'grocery'
      );
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-green-100 max-w-3xl mx-auto">
              Fresh produce, quality ingredients, and daily essentials
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Grocery Stores</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Grocery Stores Yet</h3>
            <p className="text-gray-600">
              Be the first to add a grocery store to our marketplace!
            </p>
